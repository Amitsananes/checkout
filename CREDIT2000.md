...
### Live / test guidance (from Credit2000)

- Environment is **production**. For E2E, use a small real card amount; Credit2000 can cancel the charge the same day if notified.
